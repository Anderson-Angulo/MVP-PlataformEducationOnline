...
export const Banner = ({ color, image, title, subtitle, home, poster, courseBanner ,especialidad,info }) => {
  return (
            ...
            home ?
              <div className="ed-grid m-grid-2">
                ...
                <div className="img-container s-ratio-16-9">
                  <img src={poster} alt="Curso nuevo" />
                </div>
              </div>
              ...
              courseBanner ?
                <div className="ed-grid m-grid-2">
                  <div className="main-banner__data s-center">
                    ...
                    {
                      especialidad && 
                      <p>Este curso forma parte de la especialidad
                       <Link to={`/especialidades/${especialidad.id}`}> {especialidad.name} </Link>   
                    </p>
                    }
